/**
 * ClawBands DecisionLog
 * Audit trail in JSON Lines format (~/.openclaw/clawbands/decisions.jsonl)
 */
...
const DECISIONS_FILE = path.join(CLAWBANDS_DATA_DIR, 'decisions.jsonl');
